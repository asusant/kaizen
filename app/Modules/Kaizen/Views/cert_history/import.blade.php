                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-3 text-right">
                                <label for="{{ 'history-file' }}">Employee File</label>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    {{ Form::file('history-file', ['class' => 'form-control', 'id' => 'history-file']) }}
                                    <p><small>{!! 'Upload Certification History file with given format. <code><a href="'.asset('templates/history-template.xlsx').'">Download Here</a></code>' !!}</small></p>
                                    @if ($errors->has('history-file'))
                                        <div class="invalid-feedback">{{ implode(' | ', $errors->get('history-file')) }}</div>
                                    @endif
                                </div>
                            </div>
