    ...
    <div class="row match-height">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title">Data Kegiatan RPD</h4>
                <span class="pull-right">
                    <a href="{{ route('kegiatan_rpd.rincian.create', ['id' => $prognosa->k_id]) }}" class="btn btn-outline-primary">Tambah RPD</a>
                </span>
            </div>
                                ...
                                @else
                                    ...
                                    @foreach ($data as $r)
                                        <tr>
                                            ...
                                            <td>
                                                {!! (new BApp)->btnAkses('kegiatan_rpd.rincian', $r->id_rpd, ['validate'], 'btn-sm') !!}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
