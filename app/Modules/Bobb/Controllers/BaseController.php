...
class BaseController extends Controller
{
    ...
    public $data_method = []; // Custom method untuk get data [ [namaFungsi], [parameter1, parameter2, dst] ]
    public $add_header_right = ''; // Untuk menambah object di sebelah tombol tambah data
    public $use_datatable = false; // Apakah menggunakan data table?
    ...
    public function __construct()
    {
        ...
        $dt_to_view = ['title', 'subtitle', 'breadcrumbs', 'add_title', 'base_route', 'route_params', 'add_header_right', 'use_datatable'];
