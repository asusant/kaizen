...
use App\Modules\Kaizen\Services\Rekap;
...
class BobbController extends Controller
{
    ...
    public function index()
    {
        $data = array();
        $rekap = new Rekap;
        $data['lvl_count'] = $rekap->getLvlCount();
        $data['lvl_color'] = [
            'LEVEL 1'   => 'purple',
            'LEVEL 2'   => 'blue',
            'LEVEL 3'   => 'green',
        ...
        $data['cert_year'] = $rekap->getPerYear();
        $data['pass_count'] = $rekap->getPassCount();
        // dd($data);
    ...
    *  --------------------------------------------- */
    ...
    {
        $data['data'] = SysUser::orderBy('nm_user')->get();
